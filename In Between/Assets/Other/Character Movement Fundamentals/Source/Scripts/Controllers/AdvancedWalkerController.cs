...
namespace CMF
{
	...
	public class AdvancedWalkerController : Controller {
        ...
        void HandleJumpKeyInput()
        {
            ...
            if (jumpKeyIsPressed == false && _newJumpKeyPressedState == true || Input.GetKeyDown(KeyCode.Joystick1Button0))
                jumpKeyWasPressed = true;

            if (jumpKeyIsPressed == true && _newJumpKeyPressedState == false || Input.GetKeyUp(KeyCode.Joystick1Button0))
            {
